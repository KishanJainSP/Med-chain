...
def analyze_medical_image(image_bytes: bytes) -> Dict[str, Any]:
    """Analyze medical image using fine-tuned EfficientNet"""
...
def analyze_medical_text(text: str) -> Dict[str, Any]:
    """Analyze medical text using fine-tuned text classifier"""
...
def generate_ai_response(query: str, context: str = "", image_analysis: Dict = None) -> str:
    """Generate comprehensive AI response using fine-tuned models"""
    
    keywords = get_medical_keywords(query)
    text_analysis = analyze_medical_text(query) if text_classifier_model else None
    
    # Build response based on available AI capabilities
    response_parts = []
...
def get_general_help() -> str:
    ...
    return """I'm your MedChain AI Medical Assistant powered by fine-tuned models:
- **Fine-tuned EfficientNet** for medical image analysis (trained on chest X-rays)
- **Fine-tuned Text Classifier** for medical text understanding

**I can help you with:**
- Analyzing chest X-rays for 14 different pathologies
- Classifying medical text (symptoms, diagnoses, medications, test results, treatments)
- Understanding medical conditions
- Processing medical reports and prescriptions
- General health information

**To get started:**
- Ask about a specific health condition
- Upload a chest X-ray for AI analysis
- Describe your symptoms for classification"""
